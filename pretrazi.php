      <?php
        ...
        $query = "select * from patike join boja on patike.boja_id = boja.id join velicina on patike.velicina_id = velicina.id where model like '%" . $pretraga_unos . "%' or boja like '%" . $pretraga_unos . "%' or velicina like '%" . $pretraga_unos . "%'";
